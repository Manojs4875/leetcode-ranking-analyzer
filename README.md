...
| Metric | Value |
|---|---|
| Requests | 680 in 10.17s |
| Avg Req/Sec | 63 |
| Avg Latency | 713 ms |
| Data Read | 6.35 MB |

Throughput here is bound by LeetCode's live GraphQL API response time rather than this server alone, since every request triggers a fresh external fetch with no caching layer.
